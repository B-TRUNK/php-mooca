...
if(!$error_fields){
    ...
    // Upload files
    $uploads_dir = $_SERVER['DOCUMENT_ROOT'].'/phpbsq/uploads';
    $avatar='';
...
<html>
    ...
    <body>
        <form method="post" enctype="multipart/form-data">
            ...
            <input type="email" name="email" id="email" value="<?= (isset($_POST['email'])) ? $_POST['email'] : '' ?>"/><?php if(in_array("email", $error_fields)) echo "* Please enter a valid email"; ?>
            <br />
